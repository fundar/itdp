  ...
  <div id="wrapper">
    <div id="section">
      ...
      <a href="<?php echo base_url()?>index.php/micrositio/diputado">
        <img src="<?php echo base_url()?>sources/img/diputado_btn.png" alt=""  class="coin">
      </a>
    </div>
  </div>
...
<script type="text/javascript">
    function print_chart(){
        ...
        var chartData = [
            ...
            { opcion:'', porcentaje:'$avg_tran_publico', color:'#f79420', concepto:'$str_tran|_pub'},
